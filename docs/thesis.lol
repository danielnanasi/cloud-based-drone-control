...
\select@language {magyar} \contentsline {lstlisting}{\numberline {8.3}Drón konténeréhez csatlakozás}{47}{lstlisting.8.3}%
\select@language {magyar} \contentsline {lstlisting}{\numberline {8.4}Naplózás beállítása}{47}{lstlisting.8.4}%
\select@language {magyar} \contentsline {lstlisting}{\numberline {8.5}DaemonSet megvalósítás, Roscore minden worker-en}{49}{lstlisting.8.5}%
